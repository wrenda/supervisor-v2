...
${config.emojis.star} ${user} (<@&${user.roles.highest.id}>) istatistikleri
...
${config.emojis.star} Lütfen 1 adet kategori seçin.

${config.emojis.kırmızıok} Toplam İstatistik
${config.emojis.kırmızıok} Günlük İstatistik
${config.emojis.kırmızıok} 1 Haftalık İstatistik
${config.emojis.kırmızıok} 2 Haftalık İstatistik
${config.emojis.kırmızıok} 3 Haftalık İstatistik
${config.emojis.kırmızıok} 1 Aylık İstatistik

${config.emojis.star} Örnek Kullanım:
${config.emojis.kırmızıok} .stats 1 | ${config.emojis.kırmızıok} .stats 2 | ${config.emojis.kırmızıok} .stats 3
