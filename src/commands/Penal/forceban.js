...
module.exports = {
    ...
    execute : async (client, message, args) => {
        ...
        let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Wrenda was here?").setColor("RANDOM").setTimestamp();
